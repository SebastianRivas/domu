...
<template>
    ...
    <footer class="text-center py-16 bg-gray-700 text-sm">
        ...
        <p class="mt-20 text-white"><span class="underline text-green-200 cursor-pointer">DOMU </span>created with <span class="underline text-green-200 cursor-pointer">Neutron Software.</span></p>
    </footer>
</template>
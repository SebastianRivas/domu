            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" v-for="propertyType in propertyTypesArr.data">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 text-right">
                                                <Link :href="route('masterTables.properties.show', { propertyType_id: propertyType.id })" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                                    View
                                                </Link>
                                            </td>
                                            <td class="px-6 py-4 text-right">
                                                <Link :href="route('masterTables.properties.edit', { propertyType_id: propertyType.id })" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                                    Edit
                                                </Link>
                                            </td>
                                            <td class="px-6 py-4 text-right">
                                                <Link :href="route('masterTables.properties.destroy', { propertyType_id: propertyType.id })" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                                    Delete
                                                </Link>
                                            </td>
                                        </tr>
                        ...
                        <br>
                        <div class="flex flex-col items-center">
                            <Link :href="route('masterTables.properties.create')">
